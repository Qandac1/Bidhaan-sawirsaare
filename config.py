...
Tʜɪs Bᴏᴛ Wᴀs Cʀᴇᴀᴛᴇᴅ Bʏ : @{Config.UPDATES} 💞</b>"""
...
`--change-title @{Config.UPDATES}
--change-video-title @{Config.UPDATES}
--change-audio-title @{Config.UPDATES}
--change-subtitle-title @{Config.UPDATES}
--change-author @{Config.UPDATES}`

📥 Fᴏʀ Hᴇʟᴘ Cᴏɴᴛ. @{Config.UPDATES}
"""
...
Exᴀᴍᴩʟᴇ:- `/set_suffix @{Config.UPDATES}`
Exᴀᴍᴩʟᴇ:- `/set_prefix @{Config.UPDATES}`
"""
...
#⚠️ Dᴏɴ'ᴛ Rᴇᴍᴏᴠᴇ Oᴜʀ Cʀᴇᴅɪᴛꜱ @RknDeveloper🙏🥲
    ...
    DEV_TXT = f"""Bot hosted by @{Config.UPDATES}"""
...
just replace `@{Config.UPDATES}` with your Metadata Text
"""
